...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    #add test code here
    three_length_cube = volume_of_cube( 3 )
    assert_equal( 27, three_length_cube )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    #add test code here
    three_radius_sphere = volume_of_sphere ( 5 )
    assert_equal( 392.699081625, three_radius_sphere )
  end
